...
import com.metashift.crash.ssh.term.SSHLifeCycle;
...
public class SSHPlugin extends CRaSHPlugin<SSHPlugin> {
    ...
    public static final PropertyDescriptor<String> SSH_SERVER_KEYPATH = PropertyDescriptor
            .create("ssh.keypath", (String)null, "The path to the key file");

    /** SSH host key auto generate */
    public static final PropertyDescriptor<String> SSH_SERVER_KEYGEN = PropertyDescriptor
            .create("ssh.keygen", "false", "Whether to automatically generate a host key");
